...
echo form_open('',$form_attributes);?>
   ...
   <div id="order_infor">
     	...
     	<table class="table table-bordered" id="store_infor_tbl">
          ...
          <td><select name="order_months" id="order_months" class="form-control order_months">
     ...
     //This function loops the whole form and saves all the input, select, e.t.c. elements with their corresponding values in a javascript array for processing
        ...
        $(document).on( 'change','.vaccine', function () {
		 ...
		 /*  var selected_vaccine=$(this).val();*/
		   ...
		   load_vaccine_infor(selected_vaccine,order_row);
		});
        $(document).on( 'change','.order_months', function () {
	           var order_months=$(this);
		 /*  var selected_vaccine=$(this).val();*/
		   var selected_months=order_months.val();
			    	...
			    	$.each(data,function(key,value){
                                    ...
                                    //console.log(value.batch_number);
                                     //console.log(selected_months);
                                        ...
                                        var period_stock=(value.Wastage_factor * value.Doses_required)/12;
                                        var max_stock=1.25* period_stock;
                                        var min_stock=0.25* period_stock;
                                        var quantity_order=max_stock- value.stock_balance;
